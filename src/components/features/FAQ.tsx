...
const FaqItemRow: React.FC<{
  ...
  return (
    <div className="border border-neutral-200 rounded-2xl overflow-hidden bg-white">
      <button
        className="w-full flex items-center justify-between gap-4 px-5 py-4 text-left focus:outline-none focus:ring-2 focus:ring-primary-500"
      ...
      <div
        id={contentId}
        className={`px-5 pb-4 text-neutral-700 transition-[max-height,opacity] duration-300 ease-out ${
