            ...
            <div className="pt-4 flex flex-wrap gap-3">
              ...
              >
                ...
                <div className="text-left leading-tight">
                  <div className="text-white/70 text-[10px]">Télécharger sur l'</div>
              ...
              >
                ...
                <div className="text-left leading-tight">
                  <div className="text-white/40 text-[10px]">Bientôt sur</div>
                  <div className="font-bold text-sm text-white/50">Google Play</div>
                </div>
              </div>
            </div>
          </div>
